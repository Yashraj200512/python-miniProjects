...
* **Simple Scraping:**
  * A basic script testing `requests` and `BeautifulSoup` to extract data from a URL.
...
1. **Student Manager (OOP Version):**
   ```bash
   cd python-basics/StudentDatabaseManager-usingOOPS
   python main_oops.py
   ```

2. **Student Manager (Basic Version):**
   ```bash
   cd python-basics/StudentDatabaseManager
   python main.py
   ```

3. **Random Facts Web app:**
   ```bash
